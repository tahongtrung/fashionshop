...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function() {
    ...
    Route::group(['prefix' => 'size'], function() {
        Route::get('danhsach',['as'=>'admin.size.list','uses'=>'SizeController@getList']);
        Route::get('them',['as'=>'admin.size.getAdd','uses'=>'SizeController@getAdd']);
        Route::post('them',['as'=>'admin.size.postAdd','uses'=>'SizeController@postAdd']);
        Route::get('xoa/{id}',['as'=>'admin.size.getDelete','uses'=>'SizeController@getDelete']);
        Route::get('sua/{id}',['as'=>'admin.size.getEdit','uses'=>'SizeController@getEdit']);
        Route::post('sua/{id}',['as'=>'admin.size.postEdit','uses'=>'SizeController@postEdit']);
    });
