...
<section id="aa-catg-head-banner" style="text-align: center;">
 <img src="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" alt="fashion img" style="width: 350px; height: 400px;">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="aa-product-view-slider">
                  <a href="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" class="MagicZoom" id="jeans" data-options="selectorTrigger: hover; transitionEffect: false;">
                    <img src="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" style="width: 350px; height: 400px;"></a> 
